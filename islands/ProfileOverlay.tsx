...
import { X, Settings, LogOut, Shield, ChevronRight, Globe } from "lucide-preact";
import { userSignal, soloModeSignal, toggleSoloMode, logout } from "../signals/user.ts";
...
import PrivacyManager from "./PrivacyManager.tsx";
...
export default function ProfileOverlay() {
  ...
  const activeRooms = rooms.slice().sort((a, b) => (b.count || 0) - (a.count || 0)).slice(0, 3);

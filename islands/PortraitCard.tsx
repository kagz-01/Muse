import { Shield, ExternalLink, MapPin, Quote } from "lucide-preact";
        ...
        <div className="px-8 pb-12 pt-16 text-center relative z-10">
          ...
          {user.bio && (
            <div className="mb-8 relative px-4">
               <Quote size={20} className="absolute -top-3 -left-1 text-white/5 rotate-180" />
            ...
            {(user.links || []).length > 0 ? (
              (user.links || []).map(link => (
                ...
                >
                  ...
                  <ExternalLink size={14} className="text-gray-600 group-hover/link:text-indigo-400 transition-colors duration-300 shrink-0" />
                </a>
              ))
            ) : (

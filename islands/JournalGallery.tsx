...
import { 
  Search, Plus, Flame, Target, BookOpen, ArrowRight, 
          ...
          <div className="relative group mb-8">
            ...
            <div className="relative flex items-center border border-white/10 group-focus-within:border-violet-500/40 bg-white/[0.03] group-focus-within:bg-white/5 rounded-4xl p-2 transition-all duration-500 overflow-hidden">
              ...
              <div className="absolute right-8 flex items-center gap-3">
                {search && (
                   <button onClick={() => setSearch('')} type="button" className="text-[10px] font-bold uppercase tracking-widest text-gray-500 hover:text-white transition-colors cursor-pointer">
                    Clear
                  </button>
                )}
      ...
      {!search && !showFavorites && filterMood === 'all' && (
        <div className="px-6 md:px-10 pb-8 max-w-6xl mx-auto w-full">
          <div onClick={handleNewEntry}
            ...
            <div className="absolute top-0 right-0 w-64 h-full bg-linear-to-l from-violet-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />

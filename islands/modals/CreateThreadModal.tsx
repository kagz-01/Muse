...
import { X, ArrowRight, Check, ImagePlus, Globe, Lock } from "lucide-preact";
      ...
      <div className="relative w-full max-w-lg bg-[#111318] border border-white/10 rounded-4xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom-4 duration-300 max-h-[90vh] overflow-y-auto">
        ...
        <div className="relative z-10 p-8">
          ...
          <div className="mb-5">
            ...
            <input ref={titleRef} value={title} onInput={e => { setTitle((e.target as HTMLInputElement).value); setError(''); }}
          ...
          <div className="mb-5">
            ...
            <textarea value={thesis} onInput={e => setThesis((e.target as HTMLTextAreaElement).value)}
          ...
          <div className="mb-8 p-1 bg-white/5 rounded-2xl flex gap-2">
            ...
            <button 
              ...
              className={`flex-1 py-4 rounded-xl flex items-center justify-center gap-2 transition-all cursor-pointer ${isPublic ? 'bg-indigo-500/20 text-indigo-400 shadow-xl shadow-indigo-500/5' : 'text-gray-500 hover:text-gray-300'}`}
            >
              <Globe size={16} />
          ...
          <div className="flex items-center gap-3">
            <button onClick={onClose} type="button" className="flex-1 py-4 rounded-2xl border border-white/10 text-sm font-bold uppercase tracking-widest text-gray-400 hover:text-white hover:bg-white/5 transition-all cursor-pointer">
              Cancel
            </button>

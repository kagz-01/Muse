import { Sparkles, ArrowRight, MessageSquare } from "lucide-preact";
    ...
    <section className="mb-16 mt-6 px-6 md:px-10">
      <header className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 font-serif italic">Your latest patterns and insights.</p>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <div className="absolute -top-12 -right-12 w-40 h-40 bg-indigo-500/10 blur-3xl rounded-full pointer-events-none"></div>
          ...
          <div className="flex flex-col h-full relative z-10">
            ...
            <div className="flex items-center justify-between mt-auto pt-4 border-t border-white/5">
              <div className="flex -space-x-2">
                <img src="https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=150&q=80" className="w-8 h-8 rounded-full border-[3px] border-[#1c1c1c] object-cover" alt="" />
                <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80" className="w-8 h-8 rounded-full border-[3px] border-[#1c1c1c] object-cover" alt="" />

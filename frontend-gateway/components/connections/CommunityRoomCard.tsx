import { Globe, Users, ArrowRight, Sparkles } from "lucide-preact";
    ...
    <div className="group relative h-[420px] rounded-[3rem] overflow-hidden bg-[#0d0d0d] border border-white/5 shadow-2xl transition-all duration-700 hover:border-indigo-500/40 hover:-translate-y-2">
      ...
      <div className="relative h-full z-10 p-10 flex flex-col">
        ...
        <div className="mt-auto">
           ...
           <h3 className="text-4xl font-bold tracking-tight text-white mb-4 group-hover:text-indigo-400 transition-all duration-500">{room.name}</h3>
           ...
           <div className="flex items-center justify-between pt-8 border-t border-white/10">
              ...
              <button type="button" className="w-14 h-14 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-white hover:text-black transition-all transform group-hover:rotate-[-45deg] duration-500 shadow-xl cursor-pointer">
                 <ArrowRight size={24} />
              </button>
           </div>
        </div>

...
import { Sparkles, Flame, Activity, Layers, ArrowUpRight, TrendingUp } from "lucide-preact";
      ...
      <div className="relative z-10 space-y-10">
         <div className="flex items-center justify-between">
            <h3 className="text-[10px] font-bold uppercase tracking-[0.4em] text-gray-500 flex items-center gap-3">
               <Activity size={14} className="text-canvas-primary" /> Intelligence Pulse
            </h3>
            <div className="flex items-center gap-3 px-4 py-1.5 bg-canvas-primary/10 border border-canvas-primary/30 rounded-xl">
               ...
               <span className="text-[10px] font-bold uppercase tracking-widest text-canvas-primary">{user.cognitiveStreak} Day Streak</span>
            </div>
         </div>

         <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 bg-white/2 border border-white/5 rounded-[2.5rem] text-center">
               <p className="text-[9px] font-bold uppercase tracking-widest text-gray-600 mb-2">Weekly Resonance</p>
               <div className="text-4xl font-bold text-white mb-2">{resonanceScore}%</div>
            ...
            <div className="p-8 bg-white/2 border border-white/5 rounded-[2.5rem] text-center">
               <p className="text-[9px] font-bold uppercase tracking-widest text-gray-600 mb-2">Active Syntheses</p>
               <div className="text-4xl font-bold text-white mb-2">{synthesisCount}</div>
               <p className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Live Threads</p>
            </div>

            <div className="p-8 bg-white/2 border border-white/5 rounded-[2.5rem] text-center flex flex-col justify-center">
               <p className="text-[9px] font-bold uppercase tracking-widest text-gray-600 mb-4">Top Cognitive Themes</p>
               <div className="flex flex-wrap justify-center gap-2">
                  {topThemes.map(theme => (
                    <span key={theme} className="px-3 py-1 bg-white/5 border border-white/5 rounded-lg text-[8px] font-bold uppercase tracking-widest text-white">
                       #{theme}
                    </span>
                  ))}
               </div>
         ...
         <div className="p-8 bg-canvas-primary/5 border border-canvas-primary/20 rounded-[2.5rem] flex items-center justify-between">
            <div className="flex items-center gap-4">
               ...
               <div>
                  <h4 className="text-sm font-bold text-white uppercase tracking-widest">Cognitive Blueprint Ready</h4>
                  <p className="text-[10px] text-gray-500 font-serif italic">The AI has synthesized a new pattern from your recent reflections.</p>
               </div>
            </div>

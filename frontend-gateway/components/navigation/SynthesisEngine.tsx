...
export default function SynthesisEngine() {
  ...
  const phases = [
    ...
    { id: 'synthesize', icon: GitCommit, label: 'Synthesize', color: 'text-cyan-400', desc: 'Woven diverse rooms' },
  ...
  return (
    <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-[200]">
      ...
      <div className="relative">
         ...
         {/* PHASE NODES */}
         {isOpen && (
           <div className="absolute bottom-full mb-10 left-1/2 -translate-x-1/2 w-[400px]">
                 ...
                 {phases.map((phase, i) => (
                   <button 
                     ...
                     onClick={() => {
                        ...
                        // Redirect or open specific modal logic
                     }}
              ...
              {/* SYSTEM STATUS */}
              <div className="mt-8 p-6 bg-canvas-primary/5 border border-canvas-primary/20 rounded-[2rem] flex items-center justify-between animate-in fade-in slide-in-from-bottom-4 delay-300">
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       ...
                       <p className="text-xs font-bold text-white uppercase tracking-widest">Active & Calibrated</p>
                    </div>
                 </div>
                 <div className="flex items-center gap-2">
                    <Activity size={14} className="text-emerald-500" />
                    <span className="text-[10px] font-mono text-emerald-500">12 Nodes Online</span>
                 </div>
              </div>
           </div>
         )}

...
import {
  getStreakState as getSocialStreakState,
  streaksSignal,
...
export default function MirrorDashboard() {
  ...
  const socialStreaks = streaksSignal.value.filter((s) =>
    getSocialStreakState(s) !== "broken"
  );
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-3">
                  {topThemes.length > 0
                    ? topThemes.map((theme, i) => {
                      ...
                      return (
                        <button
                          ...
                          ${
                            isActive
                              ? "bg-canvas-primary/10 border-canvas-primary/30 text-white"
                        ...
                        >
                          ...
                          <Icons.TrendingUp
                            ...
                            className={`${
                              isActive
                                ? "text-canvas-primary opacity-100"
                                : "text-emerald-400 opacity-20"
                    ...
                    : (
                      <span className="text-sm italic font-serif text-gray-500">
                ...
                <p className="text-xs text-gray-500 font-serif italic mt-6 border-l-2 border-white/10 pl-4 leading-relaxed max-w-xl transition-all">
                  {activeTheme
                    ? `Focusing Mirror on #${activeTheme}... The aura has shifted to reflect this specific pattern density.`
                    : `Hover over any theme to focus the Mirror and shift your Aura projection.`}
                </p>
              </div>
                  ...
                  <div className="bg-white/[0.02] rounded-[2.5rem] border border-white/5 p-6 md:p-10 shadow-xl space-y-6">
                    ...
                    <div className="border-t border-white/5 pt-6">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <a
                          href="/streaks"
                          className="text-[10px] font-bold uppercase tracking-widest text-canvas-primary hover:text-white transition-colors"
                        >
                          View All →
                        </a>
                      </div>
                      ...
                      {socialStreaks.length > 0
                            ...
                            {socialStreaks.slice(0, 3).map((s) => {
                              ...
                              return (
                                <a
                                  key={s.id}
                                  href="/streaks"
                                  className={`flex items-center justify-between p-3 rounded-2xl transition-all hover:bg-white/[0.04] ${
                                    isFading
                        ...
                        : (
                          <p className="text-sm italic font-serif text-gray-600">
                            No active cognitive links yet.
                          </p>
                        )}
                    </div>
                  </div>
                    ...
                    <PieChart
                      data={[
                        ...
                        },
                        {
                          ...
                          value: entries.filter((e) => e.isPublic).length,
                          color: "#f472b6",
                        },
                      ]}
                      title=""

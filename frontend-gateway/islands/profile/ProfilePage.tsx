  ...
  const achievements = [
    {
      id: "a1",
      title: "First Room",
      desc: "Created at least one room",
      unlocked: rooms.length >= 1,
    },
    {
      id: "a2",
      title: "Pattern Builder",
      desc: "Built three thematic threads",
      unlocked: threads.length >= 3,
    },
    {
      id: "a3",
      title: "Reflective Flow",
      desc: "Maintained a 3+ day journal streak",
      unlocked: journalStreak >= 3,
    },
    {
      id: "a4",
      title: "Public Curator",
      desc: "Shared five public artifacts",
      ...
      <div className="p-6 rounded-3xl bg-white/[0.03] border border-white/10 mb-6">
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-2 max-w-2xl font-serif italic">
              {user.bio || "No bio yet."}
            </p>
            ...
            <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/10">
              ...
              <div className="flex flex-wrap gap-2">
                {themes.slice(0, 8).map((theme) => (
                  <span
                    key={theme}
                    className="px-2.5 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest bg-white/10 border border-white/10 text-gray-300"
                  >
                    {theme}
                  </span>
                ))}
            ...
            >
              ...
              <p
                className={`text-[10px] mt-3 font-bold uppercase tracking-widest ${
                  achievement.unlocked ? "text-emerald-400" : "text-gray-600"
                }`}
              >

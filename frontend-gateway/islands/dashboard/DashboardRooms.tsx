      ...
      <section className="px-6 md:px-10">
        <header className="mb-8 flex items-end justify-between border-b border-white/5 pb-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1 font-serif italic">Highly personalized and expressive curation spaces.</p>
          </div>
          <div className="flex items-center gap-3">
            <a href="/rooms" className="text-xs font-bold uppercase tracking-widest text-gray-400 hover:text-white transition-colors">View All</a>
            <button onClick={() => setShowCreate(true)} type="button" className="w-9 h-9 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center text-white transition-all cursor-pointer">
              <Plus size={16} />
            </button>
          </div>
        </header>

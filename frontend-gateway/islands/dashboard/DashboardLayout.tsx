...
export default function DashboardLayout(
  { children, user }: DashboardLayoutProps,
) {
    ...
    <div className="flex h-screen bg-[var(--muse-bg)] text-[var(--muse-text)] overflow-hidden transition-colors duration-300">
      ...
      <aside className="w-64 border-r border-[var(--muse-border)] bg-[var(--muse-surface)] flex flex-col transition-colors duration-300">
        ...
        <nav className="flex-1 py-6 px-4 space-y-1 overflow-y-auto">
          ...
          <a
            href="/dashboard"
            className="flex items-center gap-3 px-3 py-2 rounded-xl bg-white/5 text-[var(--muse-text)] transition-colors"
          >
          ...
          <a
            href="#"
            className="flex items-center gap-3 px-3 py-2 rounded-xl text-[var(--muse-muted)] hover:bg-white/5 hover:text-[var(--muse-text)] transition-colors"
          >
        ...
        <div className="p-4 mx-4 mb-4 rounded-xl border border-[var(--muse-border)] bg-[var(--muse-bg)]">
          <div className="flex items-center justify-between mb-3">
            <span className="text-xs font-medium text-[var(--muse-muted)]">
              Resonance
            </span>
          ...
          <div className="flex items-baseline gap-1">
            ...
            <span className="text-xs text-[var(--muse-muted)] uppercase tracking-wider">
              HZ
            </span>
          </div>
        </div>

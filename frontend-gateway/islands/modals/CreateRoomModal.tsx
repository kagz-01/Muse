...
import { X, ArrowRight, Check, Image as ImageIcon, Globe, Lock } from "lucide-preact";
import { addRoom, type RoomTheme } from "../../signals/rooms.ts";
...
export default function CreateRoomModal({ onClose }: Props) {
  ...
  return (
    <div onClick={handleBackdropClick} className="fixed inset-0 z-[110] flex items-center justify-center bg-black/70 backdrop-blur-md p-4 animate-in fade-in duration-200">

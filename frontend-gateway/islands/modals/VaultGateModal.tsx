        ...
        <div className="bg-gradient-to-r from-slate-900 to-[#111318] p-8 border-b border-white/5 relative overflow-hidden">
          ...
          <div className="flex items-center gap-4 mb-3 relative z-10">
            <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center">
              {isRecovering
                ? <Icons.RefreshCw size={26} className="text-amber-400" />
              ...
              <div className="space-y-4 animate-in fade-in slide-in-from-top-2">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder={isSetup
                      ? "Set your answer (lowercase recommended)"
                      : "Enter your answer"}
                  ...
                  {isSetup && (
                    <p className="text-[10px] text-gray-500 italic">
                      This is the only way to recover your vault if you lose
                      your password.
                    </p>
                  )}
                </div>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              ...
              disabled={!password || (isSetup && !confirmPassword) ||
                ((isSetup || isRecovering) && !securityAnswer) || isLoading}
            >
              {isLoading
                ? (
              ...
              {!confirmNuke
                ...
                : (
                  <div className="bg-rose-500/10 p-4 rounded-2xl border border-rose-500/30 animate-in fade-in">
                    <p className="text-xs text-rose-400 mb-3 font-bold">
                      This will permanently delete your master password and lock
                      out all current vault rooms.
                    </p>
                    <div className="flex gap-2">
                      <button
                        type="button"
                        onClick={() => setConfirmNuke(false)}
                        className="flex-[1] py-2 text-xs rounded-xl border border-white/10 text-gray-300"
                      >
                        Cancel
                      </button>
                      <button
                        type="button"
                        onClick={handleNuke}
                        className="flex-[1] py-2 text-xs rounded-xl bg-rose-500 text-white font-bold uppercase tracking-widest shadow-xl"
                      >
                        Confirm Nuke
                      </button>
                    </div>

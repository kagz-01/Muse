...
import { wisdomNodesSignal, WisdomNode } from "../../signals/connections.ts";
import { Sparkles, Activity, Zap } from "lucide-preact";
    ...
    <div className="relative w-full h-[600px] bg-[#0d0d0d] rounded-[4rem] border border-white/5 overflow-hidden group shadow-2xl">
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none">
        <defs>
          <linearGradient id="lineGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stop-color="var(--muse-accent-rgb)" stop-opacity="0.2" />
            <stop offset="100%" stop-color="var(--muse-accent-rgb)" stop-opacity="0.1" />
          </linearGradient>
        </defs>
          ...
          >
            ...
            >
               ...
               <div className="relative z-10 text-center px-4">
                  <p className="text-[10px] font-bold uppercase tracking-widest text-white group-hover/node:text-canvas-primary transition-colors">{node.topic}</p>
                  <p className="text-[8px] font-bold text-gray-600 mt-1 uppercase tracking-tighter opacity-0 group-hover/node:opacity-100 transition-opacity">Connect</p>
               </div>
            </div>
          </div>
        ))}
      ...
      <div className="absolute top-10 left-10 p-6 rounded-3xl bg-black/40 backdrop-blur-xl border border-white/5 space-y-4">
         <div className="flex items-center gap-3">
            ...
            <h3 className="text-[10px] font-bold uppercase tracking-[0.4em] text-white">Wisdom Map v3.0</h3>
         </div>
         ...
         <div className="flex items-center gap-4 pt-2 border-t border-white/5">
            <div className="flex items-center gap-2">
               ...
               <span className="text-[8px] font-bold text-gray-600 uppercase tracking-widest">Active Node</span>
            </div>
            <div className="flex items-center gap-2">
               <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
               <span className="text-[8px] font-bold text-gray-600 uppercase tracking-widest">High Resonance</span>
            </div>
         </div>
      </div>

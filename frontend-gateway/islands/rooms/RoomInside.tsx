...
export default function RoomInside({ roomId }: { roomId: string }) {
  ...
  const [activeTab, setActiveTab] = useState<'collection' | 'dialogue'>('collection');
  ...
  return (
    <>
      ...
      <div className="pb-24 md:pb-10 min-h-screen bg-[#0a0a0a] relative overflow-hidden">
        <div className={`fixed inset-0 pointer-events-none ${theme.bg} blur-[120px] opacity-20 transition-colors duration-1000`} />
            ...
            <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-3xl p-6 md:p-8 relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="flex-1 min-w-0">
                  <h1 className="text-3xl md:text-5xl font-bold tracking-tight text-white mb-3 drop-shadow-xl">{room.name}</h1>
                  {room.description && (
            ...
            <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
               ...
               <div className="flex items-center justify-between mb-8">
                  <h3 className="text-3xl font-bold text-white tracking-tight flex items-center gap-4">
                     <Layers size={32} className="text-gray-800" /> Curated Clusters
                  </h3>
                  <button
               ...
               {items.length === 0 ? (
                 <div className="flex flex-col items-center justify-center py-32 bg-[#111318]/50 backdrop-blur-md rounded-[3rem] border border-white/5">
                    ...
                    <p className="text-white text-2xl font-bold tracking-tight mb-2">This space is expectant.</p>
                    <p className="text-gray-500 font-serif italic text-lg mb-10 max-w-lg text-center">Your artifacts will appear here as clusters of intelligence. Begin the collection phase.</p>
               ...
               <div className="bg-white/2 border border-white/5 rounded-[3.5rem] p-12 md:p-20 text-center relative overflow-hidden">
                  ...
                  <div className="relative z-10 max-w-4xl mx-auto">
                     ...
                     <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 tracking-tight">
                        Contemplate the <span className={`italic font-serif ${theme.text}`}>Patterns.</span>
                     </h2>
                     <p className="text-xl md:text-2xl text-gray-400 font-serif italic leading-relaxed mb-12">
                        "Dialogue is the bridge between consumption and synthesis. Talk to your room to discover the hidden lineage of your collected signals."
                     </p>
                  ...
                  <div className="p-10 bg-white/[0.02] border border-white/5 rounded-[3rem]">
                     ...
                     <div className="space-y-6">
                        <p className="text-lg text-white font-serif italic leading-relaxed">
                           "This room is showing a strong resonance with 'Aesthetic Brutalism'. 3 out of 5 artifacts mention raw materials as a form of honesty."
                        </p>
                        <div className="flex items-center gap-3">
                           <div className="h-1 flex-1 bg-white/5 rounded-full overflow-hidden">
                              <div className={`h-full ${theme.bg.replace('/10', '/60')} w-[65%]`} />
                           </div>
                           <span className="text-[10px] font-mono text-gray-500">65% Synthesis</span>
                        </div>
                     </div>
                  </div>

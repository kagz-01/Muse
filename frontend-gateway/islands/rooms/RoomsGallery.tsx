  ...
  return (
    <>
      ...
      <ConfirmDeleteModal
        ...
        title="Delete Room?"
        description="This room and all its configuration will be permanently removed. Artifacts inside are not deleted."
        onConfirm={() => {
          if (pendingDeleteId) confirmDeleteRoom(pendingDeleteId);
        }}

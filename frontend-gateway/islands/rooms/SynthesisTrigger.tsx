...
export default function SynthesisTrigger(
  { roomId, themeColor }: SynthesisTriggerProps,
) {
      ...
      {isProcessing && (
        <div className="fixed inset-0 z-[200] flex flex-col items-center justify-center p-4 bg-black/90 backdrop-blur-lg animate-in fade-in duration-500">
          ...
          <p className="text-zinc-400 font-mono text-xs max-w-md text-center">
            The AI engine is reading artifacts, finding connections, and
            generating structural blueprints. This may take a moment.
          </p>
        </div>
      )}
    </>

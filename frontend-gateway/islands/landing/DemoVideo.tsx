        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          <div className="relative text-center space-y-8 p-12">
            ...
            <p className="max-w-xl mx-auto text-gray-500 font-serif italic text-lg leading-relaxed">
              Experience the seamless flow of Muse 2.0. From capture to
              synthesis, witness the evolution of your digital consciousness.
            </p>
            ...
            <div className="pt-10 flex flex-wrap justify-center gap-4">
              {[
                ...
                <div
                  key={tag.label}
                  className="px-6 py-3 rounded-full bg-white/5 border border-white/10 flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest text-gray-400"
                >
                  <tag.icon size={14} className="text-canvas-primary" />{" "}
                  {tag.label}
                </div>
              ))}
            </div>

...
export default function AboutSection() {
  return (
    <section id="about" className="max-w-[1800px] mx-auto px-6 md:px-10 py-32 space-y-20 relative border-t border-[var(--muse-border)] transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
        <div className="bg-[var(--muse-surface)] border border-[var(--muse-border)] rounded-[2.5rem] p-12 hover:bg-[var(--muse-surface-soft)] transition-all duration-300">
           ...
           <h4 className="text-2xl font-bold text-[var(--muse-text)] mb-4 tracking-tight transition-colors duration-300">The Vision</h4>
        ...
        <div className="bg-[var(--muse-surface)] border border-[var(--muse-border)] rounded-[2.5rem] p-12 hover:bg-[var(--muse-surface-soft)] transition-all duration-300">
           ...
           <h4 className="text-2xl font-bold text-[var(--muse-text)] mb-4 tracking-tight transition-colors duration-300">The System</h4>
           <p className="text-[var(--muse-muted)] font-serif text-lg leading-relaxed transition-colors duration-300">

            ...
            return (
              ...
              >
                ...
                <div className="p-8 pb-10">
                  <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-canvas-primary transition-colors">
                    {thread.title}
                  </h3>
                  <p className="text-gray-400 font-serif italic leading-relaxed line-clamp-2 mb-8">
                    "{thread.description}"
                  </p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex -space-x-2">
                        {thread.sourceRoomIds.map((roomId: string) => (
                          <div
                            key={roomId}
                            className="w-6 h-6 rounded-full bg-white/10 border border-[#111] flex items-center justify-center text-[7px] font-bold uppercase text-white"
                          >
                            {roomId.toUpperCase()}
                          </div>
                        ))}
